...
<body>
    ...
    <div class="container">
        <div class="view_detail">
            <div class="header">
                <img src="<?= BASE_URL ?>/images/profile/<?= $this->data['user_id'] ?>.jpg" alt="profile_picture" class="profile_picture">
            ...
            <form class="profile_detail">
                ...
                <div class="flex-col gap-4">
                    ...
                    <?php
                        $videoFilePath = BASE_URL . '/videos/' . $this->data['user_id'] . '.mp4';
                        $checkVideoPath = __DIR__ . '/../../../public/videos/' . $this->data['user_id'] . '.mp4';
    ...
    <div class="popup-delete-user">
        ...
        <div class="button-container-popup">
            <button class="no-button" type="button"><strong>No</strong></button>
    ...
    <script src="<?= BASE_URL ?>/js/profileAdmin.js"></script>
</body>
</html>